...
import {
  StatusBar, View, ActivityIndicator, StyleSheet, Image,
} from "react-native";
...
export default class App extends React.Component<{}, AppState> {
  ...
  async componentDidMount() {
    ...
    let avatarUrls=[]
    stories.map(story=>{
      Image.prefetch(String(story.source),(res)=>imgUrls.push(res))
      Image.prefetch(String(story.avatar),(res)=>avatarUrls.push(res))
    })

    Promise.all(imgUrls,avatarUrls).then(()=>{
